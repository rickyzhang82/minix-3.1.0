/* $Id: parco.c,v 1.1 2005/09/01 12:13:23 beng Exp $ */
...
void
pc_begin(void *s_brk,identification id)
...
void
init_between(struct procgroup *group)
...
void block_move(wordsize,void*,void*);

void
save_between(struct procgroup *group)
...
void
delete_between(struct procgroup *group)
