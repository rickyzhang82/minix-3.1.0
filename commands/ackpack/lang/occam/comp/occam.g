/* $Id: occam.g,v 1.1 2005/09/01 12:13:23 beng Exp $ */
/*
...
static void nonconst(char *);
static void nonpositive(char *);
static void rep_cleanup(struct expr *, struct expr *);
static void check_assoc(int, int);
...
static
void
rep_cleanup(struct expr *e1,struct expr *e2)
{
	destroy(e1);
	destroy(e2);
	sym_up();
...
static
void
check_assoc(int prev_op,int op)
{
	switch (op) {
		char prev[5];
	case '+':	case '*':
