...
#ifndef NORSCID
static char rcs_id[] = "$Id: gencode.c,v 1.1 2005/09/01 12:13:17 beng Exp $" ;
#endif
...
void
writestmt(int exprtype,int comma)
{
...
prolog2(void)
{
	...
	if ( datfile==0 ) fatal("improper file creation permission");
        gendata();
}
