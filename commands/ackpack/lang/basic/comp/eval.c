...
#ifndef NORSCID
static char rcs_id[] = "$Id: eval.c,v 1.1 2005/09/01 12:13:17 beng Exp $" ;
#endif
...
void
conversion(int oldtype,int newtype)
{
...
void
extraconvert(int oldtype,int newtype,int topstack)
{
...
int
boolop(int ltype,int rtype,int operator)
{
	if ( operator != NOTSYM)
	{
...
int
relop(int ltype,int rtype,int operator)
{
	int	result;
...
int
plusmin(int ltype,int rtype,int operator)
{
	int result;
...
int
muldiv(int ltype,int rtype,int operator)
{
	int result;
