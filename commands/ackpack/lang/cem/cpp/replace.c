 ...
 */
/* $Id: replace.c,v 1.1 2005/09/01 12:13:20 beng Exp $ */
...
static void stash(struct repl *,int,int);
static char * stringify(struct repl *repl,char *ptr,struct args *args);

int
replace(struct idf *idf)
{
...
static
int
expand_macro(struct repl *repl,struct idf *idf)
{
...
static
void
expand_defined(struct repl *repl)
{
...
static
void
getactuals(struct repl *repl,struct idf *idf)
{
...
static
void
macro2buffer(struct repl *repl,struct idf *idf,struct args *args)
{
...
static
char *
stringify(struct repl *repl,char *ptr,struct args *args)
{
 ...
 */
void
add2repl(struct repl *repl,int ch)
{
...
static
void
stash(struct repl *repl,int ch,int stashraw)
{
