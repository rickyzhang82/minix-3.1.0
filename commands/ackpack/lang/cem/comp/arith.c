 ...
 */
/* $Id: arith.c,v 1.1 2005/09/01 12:13:19 beng Exp $ */
...
static void ch3pointer(struct expr **,int,struct type *);


void
arithbalance(struct expr **e1p, int oper,struct expr ** e2p)	/* 3.1.2.5 */
{
...
void
relbalance(struct expr ** e1p,int oper,struct expr ** e2p)
{
	/*	The expressions *e1p and *e2p are balanced to be operands
...
static
void
ch3pointer(struct expr **expp,int oper,struct type *tp)
{
...
void
erroneous2int(struct expr **expp)
{
...
struct expr *
arith2arith(struct type *tp,int oper,struct expr *expr)
{
...
int
int2int(struct expr **expp,struct type *tp)
{
 ...
 */
void
int2float(struct expr **expp,struct type *tp)
{
	/*	The expression *expp, which is of some integral type, is
...
void
float2float(struct expr **expp,struct type *tp)
{
	/*	The expression *expp, which is of some floating type, is
		converted to the floating type tp.
...
void
function2pointer(struct expr *exp)
{
...
void
opnd2integral(struct expr **expp,int oper)
{
...
void
opnd2logical(struct expr **expp,int oper)
{
...
void
any2opnd(struct expr **expp,int oper)
{
	if (!*expp)
		return;
...
void
any2parameter(struct expr **expp)
{
