...
static void init_specials(struct sp_id *);
...
compile(int argc,char *argv[])
{
	...
	if (!InsertFile(source, 0, &result)) /* read the source file	*/
...
void
C_failed(void)				/* called by EM_code module */
{
	fatal("write failed");
}
