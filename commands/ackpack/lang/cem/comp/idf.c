 ...
 */
/* $Id: idf.c,v 1.1 2005/09/01 12:13:19 beng Exp $ */
...
static void global_redecl(struct idf *,int,struct type *);
static int good_formal(struct def *,struct idf *);
static void declare_parameter(struct idf *);
...
int
is_anon_idf(struct idf *idf)
{
	return idf->id_text[0] == '#';
}

void
declare_idf(struct decspecs *ds,struct declarator *dc,int lvl)
{
...
int
actual_declaration(int sc,struct type *tp)
{
...
static
void
global_redecl(struct idf *idf,int new_sc,struct type *tp)
{
...
static
int
good_formal(struct def *def,struct idf *idf)
{
...
void
declare_params(struct declarator *dc)
{
...
void
idf_initialized(struct idf *idf)
{
...
static
void
declare_parameter(struct idf *idf)
{
...
void
declare_enum(struct type *tp,struct idf *idf,arith l)
{
...
void
check_formals(struct idf *idf,struct declarator *dc)
{
	register struct formal *fm = dc->dc_formal;
...
void
declare_formals(struct idf *idf,arith *fp)
{
...
void
add_def(struct idf *idf,int sc,struct type *tp,int lvl)
{
