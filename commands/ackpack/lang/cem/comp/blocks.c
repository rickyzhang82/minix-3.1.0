 ...
 */
/* $Id: blocks.c,v 1.1 2005/09/01 12:13:19 beng Exp $ */
...
#ifndef STB
static void copy_loop(arith,arith,arith);
#endif
...
static
void
copy_loop(arith sz,arith src,arith dst)
{
