...
/* $Id: util.c,v 1.1 2005/09/01 12:13:20 beng Exp $ */
...
arith
NewLocal(arith sz,int al,int regtype,int sc)
{
...
void
RegisterAccount(arith offset,arith size,int regtype,int sc)
{
