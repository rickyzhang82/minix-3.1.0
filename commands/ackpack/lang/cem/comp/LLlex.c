 ...
 */
/* $Id: LLlex.c,v 1.1 2005/09/01 12:13:19 beng Exp $ */
...
static
char *
string_token(char *nm,int stop_char,int *plen)
{
	register int ch;
...
static
void
strflt2tok(char fltbuf[],struct token *ptok)
{
...
static
void
strint2tok(char intbuf[],struct token *ptok)
{
