 ...
 */
/* $Id: expr.c,v 1.1 2005/09/01 12:13:19 beng Exp $ */
...
static void idf2expr(struct expr *);
static void int2expr(struct expr *);
static void float2expr(struct expr *);
...
void
string2expr(struct expr **expp,char *str,int len)
{
...
void
fill_int_expr(struct expr *ex,arith ivalue,int fund)
{
...
struct expr *
new_oper(struct type *tp,struct expr *e1,int oper,struct expr *e2)
{
...
void
init_expression(struct expr ***eppp,struct expr *expr)
{
...
void
free_expression(struct expr *expr)
{
