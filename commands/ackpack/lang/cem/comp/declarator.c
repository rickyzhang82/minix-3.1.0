 ...
 */
/* $Id: declarator.c,v 1.1 2005/09/01 12:13:19 beng Exp $ */
...
void
add_decl_unary(struct declarator *dc,int fund,int qual,arith count,struct formal *fm,struct proto *pl)
{
...
void
remove_declarator(struct declarator *dc)
{
...
void
reject_params(struct declarator *dc)
{
...
void
check_array_subscript(struct expr *expr)
{
