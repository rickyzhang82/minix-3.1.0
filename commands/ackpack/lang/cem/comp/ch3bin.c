 ...
 */
/* $Id: ch3bin.c,v 1.1 2005/09/01 12:13:19 beng Exp $ */
...
static void pointer_binary(struct expr **,int,struct expr *);
static void pntminuspnt(struct expr **,int,struct expr *);
...
static
void
pntminuspnt(struct expr **expp,int oper,struct expr *expr)
{
...
void
mk_binop(struct expr **expp,int oper,struct expr *expr,int commutative)
{
...
void
pointer_arithmetic(struct expr **expp1,int oper,struct expr **expp2)
{
	int typ;
...
static
void
pointer_binary(struct expr **expp,int oper,struct expr *expr)
{
