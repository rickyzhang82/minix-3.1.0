 ...
 */
/* $Id: proto.c,v 1.1 2005/09/01 12:13:20 beng Exp $ */
...
void
check_for_void(struct proto *pl)
{
...
void
add_proto(struct proto *pl,struct decspecs *ds,struct declarator *dc,int lvl)
{
...
struct tag *
gettag(struct type *tp,struct idf **idpp)
{
...
void
declare_protos(struct declarator *dc)
{
...
void
update_proto(struct type *tp,struct type *otp)
{
...
static
void
remove_proto_tag(struct type *tp)
{
...
void
remove_proto_idfs(struct proto *pl)
{
