 ...
 */
/* $Id: eval.c,v 1.1 2005/09/01 12:13:19 beng Exp $ */
...
void
EVAL(struct expr *expr,int val,int code,label true_label,label false_label)
{
...
void
assop(struct type *type,int oper)
{
	register arith size;
...
*/
void
store_val(struct value *vl,struct type *tp)
{
...
*/
void
load_val(struct expr *expr,int  rlval)
#if 0
...
void
operands(struct expr *expr,int gencode)
{
