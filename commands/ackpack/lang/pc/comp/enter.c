...
struct def *
Enter(char * name,long kind,struct type * type,int pnam)
{
...
void
EnterProgList(struct node * Idlist)
{
...
void
EnterEnumList(struct node * Idlist,struct type * type)
{
...
void
EnterFieldList(struct node * Idlist,struct type * type,struct scope * scope,arith * addr,unsigned short packed)
{
...
void
EnterVarList(struct node * Idlist,struct type * type,int local)
{
...
static
void
LinkParam(struct paramlist ** parlist,struct def * df)
{
...
arith
EnterParamList(struct node * fpl,struct paramlist ** parlist)
{
...
arith
EnterParTypes(struct node *fpl,struct paramlist ** parlist)
{
