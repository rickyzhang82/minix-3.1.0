...
STATIC int
properly(struct desig * ds,arith size,int al)
{
...
static
void
CodeCopy(struct desig * lhs,struct desig * rhs,arith sz,arith * psize)
{
	struct desig l, r;
...
void
CodeValue(struct desig * ds,struct type * tp)
{
...
void
CodeStore(struct desig * ds,struct type * tp)
{
...
void
CodeMove(struct desig * rhs,struct node * left,struct type * rtp)
{
	struct desig dsl;
...
static
void
CodeFieldDesig(struct def * df,struct desig * ds)
{
...
static
void
CodeVarDesig(struct def * df,struct desig * ds)
{
...
static
void
CodeBoundDesig(struct def * df,struct desig * ds)
{
...
static
void
CodeFuncDesig(struct def * df,struct desig * ds)
{
...
void
CodeDesig(struct node * nd,struct desig * ds)
{
