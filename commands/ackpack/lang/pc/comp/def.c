...
struct def *
MkDef(struct idf * id,struct scope * scope,long kind)
{
...
struct def *
define(struct idf * id,struct scope * scope,long kind)
{
...
void
DoDirective(struct idf * directive,struct node * nd,struct type * tp,struct scopelist * scl,int function)
{
...
struct def *
DeclProc(struct node * nd,struct type * tp,struct scopelist * scl)
{
	register struct def *df;
...
struct def *
DeclFunc(struct node * nd,struct type * tp,struct scopelist * scl)
{
	register struct def *df;
