...
struct type *
construct_type(int fund,struct type * tp)
{
...
struct type *
proc_type(struct paramlist * parameters,arith n_bytes_params)
{
...
struct type *
func_type(struct paramlist * parameters,arith n_bytes_params,struct type * resulttype)
{
...
void
chk_type_id(struct type **ptp,struct node *nd)
{
...
struct type *
subr_type(struct node * lb,struct node * ub)
{
...
void
getbounds(struct type * tp,arith * plo,arith * phi)
{
...
struct type *
set_type(struct type * tp,unsigned short packed)
{
...
static
arith
ArrayElSize(struct type * tp,int packed)
{
...
static
void
FreeForward(struct forwtype * for_type)
{
	if( !for_type ) return;
...
void
TstCaseConstants(struct node * nd,struct selector * sel,struct selector * sel1)
{
