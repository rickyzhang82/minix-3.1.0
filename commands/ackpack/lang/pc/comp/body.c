...
void
MarkDef(struct node * nd,unsigned short flags,int on)
{
...
void
AssertStat(struct node * expp,unsigned short line)
{
	struct desig dsr;
...
void
AssignStat(struct node * left,struct node * right)
{
...
arith
CodeInitFor(struct node * nd,int priority)
{
...
void
CodeFor(struct node * nd,int stepsize,label l1,label l2)
{
...
void
CodeEndFor(struct node * nd,int stepsize,label l1,label l2,arith tmp2)
{
...
void
EndWith(struct scopelist * saved_scl,struct node * nd)
{
