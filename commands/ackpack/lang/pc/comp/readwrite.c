...
static
void
CodeRead(struct node * file,struct node * arg)
{
...
static
void
CodeWrite(struct node * file,struct node * arg)
{
	int width = 0;
...
static
int
ChkWriteParameter(struct type * filetype,struct node * arg,char * name)
{
	struct type *tp;
...
struct node *
ChkStdInOut(const char * name,int st_out)
{
