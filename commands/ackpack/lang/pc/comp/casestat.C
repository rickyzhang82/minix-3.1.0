...
static
void
CaseCode(label lbl,struct case_hdr * ch,label exit_label)
{
...
static
int
AddOneCase(struct case_hdr * ch,struct node * nd,label lbl)
{
...
static
int
AddCases(struct case_hdr * ch,struct node * nd,label CaseLabel)
{
	while( nd )	{
...
void
CaseEnd(struct node * nd,label exit_label)
{
