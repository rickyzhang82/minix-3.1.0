...
static
void
overflow(struct node *expp)
{
	node_warning(expp, "overflow in constant expression");
}

void
cstunary(struct node *expp)
{
...
void
cstcall(struct node * expp,int req)
{
