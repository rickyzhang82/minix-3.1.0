...
int
TstTypeEquiv(struct type * tp1,struct type * tp2)
{
...
static
int
TstStrCompat(struct type * tp1,struct type * tp2)
{
...
int
TstCompat(struct type * tp1,struct type * tp2)
{
...
int
TstAssCompat(struct type * tp1,struct type * tp2)
{
...
static int TstParEquiv(struct type * tp1,struct type * tp2);	/* forward */

static
int
TstProcEquiv(struct type * tp1,struct type * tp2)
{
...
static
int
TstParEquiv(struct type * tp1,struct type * tp2)
{
...
static
int
TstConform(struct type * formaltype,struct type * actualtype,int new_par_section)
{
...
int
TstParCompat(struct type * formaltype,struct type * actualtype,int VARflag,struct node * nd,int new_par_section)
{
