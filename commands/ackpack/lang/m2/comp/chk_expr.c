...
/* $Id: chk_expr.c,v 1.1 2005/09/01 12:13:21 beng Exp $ */
...
STATIC
void
df_error(t_node *nd,char *mess,t_def *edf)
	/* nd -- node on which error occurred */
	/* mess -- error message */
	/* edf -- do we have a name? */
{
	if (edf) {
...
void
MkCoercion(t_node **pnd,t_type *tp)
{
...
int
ChkVariable(t_node **expp,int flags)
{
...
STATIC int
ChkArrow(t_node **expp,int ignored)
{
...
/*ARGSUSED*/
STATIC int
ChkValue(t_node **expp,int ignored)
{
#ifdef DEBUG
	switch((*expp)->nd_symb) {
	case REAL:
...
STATIC int
ChkSelOrName(t_node **expp,int flags)
{
...
STATIC int
ChkExSelOrName(t_node **expp,int ignored)
{
...
STATIC int
ChkEl(t_node **expp,t_type *tp)
{
	return ChkExpression(expp) && ChkCompat(expp, tp, "set element");
}

STATIC int
ChkElement(t_node **expp,t_type *tp,arith *set)
{
...
STATIC int
ChkSet(t_node **expp,int ignored)
{
...
STATIC t_node *
getarg(t_node **argp,int bases,int designator,t_def *edf)
{
...
STATIC t_node *
getname(t_node **argp,int kinds,int bases,t_def *edf)
{
...
void
TryToString(t_node *nd,t_type *tp)
{
...
STATIC int
ChkFunCall(t_node **expp,int ignored)
{
...
STATIC t_type *
ResultOfOperation(int operator,t_type *tp)
{
...
STATIC int
ChkAddressOper(t_type *tpl,t_type *tpr,t_node *expp)
{
...
STATIC int
ChkBinOper(t_node **expp,int ignored)
{
...
STATIC int
ChkUnOper(t_node **expp,int ignored)
{
...
STATIC t_node *
getvariable(t_node **argp,t_def *edf,int flags)
{
	/*	Get the next argument from argument list "argp".
...
STATIC int
no_desig(t_node **expp,int ignored)
{
...
STATIC int
add_flags(t_node **expp,int flags)
{
