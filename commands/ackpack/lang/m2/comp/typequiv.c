...
/* $Id: typequiv.c,v 1.1 2005/09/01 12:13:21 beng Exp $ */
...
static
int
TstTypeEquiv(t_type *tp1,t_type *tp2)
{
...
static
int
TstParEquiv(t_type *tp1,t_type *tp2)
{
...
int
TstProcEquiv(t_type *tp1,t_type *tp2)
{
...
int
TstCompat(t_type *tp1,t_type *tp2)
{
...
int
TstAssCompat(t_type *tp1,t_type *tp2)
{
...
char *
incompat(t_type *tp1,t_type *tp2)
{
...
int
TstParCompat(int parno,t_type *formaltype,int VARflag,t_node **nd,t_def *edf)
{
...
static
int
CompatCheck(t_node **nd,t_type *tp,char *message,int (*fc)(t_type*,t_type*))
{
	if (! (*fc)(tp, (*nd)->nd_type)) {
		if (message) {
...
int
ChkAssCompat(t_node **nd,t_type *tp,char *message)
{
...
int
ChkCompat(t_node **nd,t_type *tp,char *message)
{
