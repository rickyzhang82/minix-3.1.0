...
/* $Id: def.c,v 1.1 2005/09/01 12:13:21 beng Exp $ */
...
t_def *
MkDef(t_idf *id,t_scope *scope,int kind)
{
...
t_def *
define(t_idf *id,t_scope *scope,int kind)
{
...
void
CheckWithDef(t_def *df,t_type *tp)
{
