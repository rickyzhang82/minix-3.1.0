...
/* $Id: walk.c,v 1.1 2005/09/01 12:13:21 beng Exp $ */
...
int
LblWalkNode(label lbl,t_node *nd,int exit,int reach)
{
...
static
int
WalkDesignator(t_node **pnd,t_desig *ds,int flags)
{
...
static
void
df_warning(t_node *nd,t_def *df,char *warning)
{
...
static
void
WalkDefList(t_def *df,void (*proc)(t_def *))
{
...
static void WalkDef(t_def *df); /* forward */

static
void
WalkProcedure(t_def *procedure)
{
...
static
int
WalkLink(t_node *nd,label exit_label,int end_reached)
{
...
static
void
ExpectBool(t_node **pnd,label true_label,label false_label)
{
...
static
int
WalkStat(t_node *nd,label exit_label,int end_reached)
{
