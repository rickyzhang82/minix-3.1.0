...
/* $Id: type.c,v 1.1 2005/09/01 12:13:21 beng Exp $ */
...
t_type *
construct_type(int fund,t_type *tp)
{
...
t_type *
standard_type(int fund,int algn,arith size)
{
...
int
chk_bounds(arith l1,arith l2,int fund)
{
...
t_type *
subr_type(t_node *lb,t_node *ub,t_type *base)
{
...
t_type *
proc_type(t_type *result_type,t_param *parameters,arith n_bytes_params)
{
...
void
getbounds(t_type *tp,arith *plo,arith *phi)
{
...
void
DeclareType(t_node *nd,t_def *df,t_type *tp)
{
...
t_type *
intorcard(t_type *left,t_type *right)
{
