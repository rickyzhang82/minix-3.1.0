...
/* $Id: desig.c,v 1.1 2005/09/01 12:13:21 beng Exp $ */
...
static
int
WordOrDouble(t_desig *ds,arith size)
{
...
void
CodeValue(t_desig *ds,t_type *tp)
{
...
void
CodeStore(t_desig *ds,t_type *tp)
{
...
static
void
CodeCopy(t_desig *lhs,t_desig *rhs,arith sz,arith *psize)
{
...
void
CodeMove(t_desig *rhs,t_node *left,t_type *rtp)
{
...
static
void
CodeFieldDesig(t_def *df,t_desig *ds)
{
...
static
void
CodeVarDesig(t_def *df,t_desig *ds)
{
...
void
CodeDesig(t_node *nd,t_desig *ds)
{
