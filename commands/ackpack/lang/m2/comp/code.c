...
/* $Id: code.c,v 1.1 2005/09/01 12:13:21 beng Exp $ */
...
void
CodePString(t_node *nd,t_type *tp)
{
...
static
void
CodeDAddress(t_node *nd,int chk_controlvar)
{
...
static
void
CodeParameters(t_param *param,t_node *arg)
{
	register t_type *tp;
...
static
int
needs_rangecheck(t_type *tpl,t_type *tpr)
{
	arith rlo, rhi;
...
static
void
CodeOper(t_node *expr,label true_label,label false_label)
{
...
static
void
CodeEl(t_node *nd,t_type *tp,int null_set)
{
...
static
void
CodeSet(t_node *nd,int null_set)
{
	register t_type *tp = nd->nd_type;
...
void
CodeExpr(t_node *nd,t_desig *ds,label true_label,label false_label)
{
	register t_type *tp = nd->nd_type;
...
void
CodeCoercion(t_type *t1,t_type *t2)
{
	int fund1, fund2;
	int sz1 = t1->tp_size;
	int sz2;
...
void
RangeCheck(t_type *tpl,t_type *tpr)
{
