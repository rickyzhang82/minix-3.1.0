...
/* $Id: enter.c,v 1.1 2005/09/01 12:13:21 beng Exp $ */
...
t_def *
Enter(char *name,int kind,t_type *type,int pnam)
{
...
t_def *
EnterType(char *name,t_type *type)
{
...
void
EnterEnumList(t_node *Idlist,t_type *type)
{
...
void
EnterFieldList(t_node *Idlist,t_type *type,t_scope *scope,arith *addr)
{
...
void
EnterVarList(t_node *Idlist,t_type *type,int local)
{
...
void
EnterParamList(t_param **ppr,t_node *Idlist,t_type *type,int VARp,arith *off)
{
...
STATIC t_def *DoImport(t_def *df,t_scope *scope,int flag);

static
void
ImportEffects(t_def *idef,t_scope *scope,int flag)
{
...
STATIC t_def *
DoImport(t_def *df,t_scope *scope,int flag)
{
...
STATIC t_def *
ForwDef(t_node *ids,t_scope *scope)
{
...
void
EnterExportList(t_node *Idlist,int qualified)
{
...
void
EnterImportList(t_node *idlist,int local,t_scope *sc)
{
...
void
EnterFromImportList(t_node *idlist,t_def *FromDef,t_node *FromId)
{
	/*	Import the list Idlist from the module indicated by Fromdef.
	*/
	t_scope *sc;
	register t_def *df;
	const char *module_name = FromDef->df_idf->id_text;
