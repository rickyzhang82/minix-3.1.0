...
/* $Id: casestat.C,v 1.1 2005/09/01 12:13:21 beng Exp $ */
...
static
int
compact(int nr,arith low,arith up)
{
...
static
void
AddOneCase(struct switch_hdr *sh,t_node *lnode,t_node *rnode,label lbl)
{
...
static
void
AddCases(struct switch_hdr *sh,t_node *node,label lbl)
{
...
int
CaseCode(t_node *nd,label exitlabel,int end_reached)
{
