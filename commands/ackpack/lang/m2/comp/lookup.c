...
/* $Id: lookup.c,v 1.1 2005/09/01 12:13:21 beng Exp $ */
...
t_def *
lookup(t_idf *id,t_scope *scope,int import,int flags)
{
...
t_def *
lookfor(t_node *id,t_scopelist *vis,int message,int flags)
{
