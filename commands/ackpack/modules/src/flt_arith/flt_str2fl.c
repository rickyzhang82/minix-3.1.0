...
/* $Id: flt_str2fl.c,v 1.3 2005/09/01 12:13:26 beng Exp $ */
...
static
void
add_exponent(flt_arith *e,int exp)
{
	int neg = exp < 0;
	int divsz, modsz;
	flt_arith x;
...
void
flt_str2flt(char *s,flt_arith *e)
{
	register int	c;
	int		dotseen = 0;
	int		digitseen = 0;
...
static
char *
flt_ecvt(flt_arith *e,int *decpt,int *sign)
{
...
void
flt_flt2str(flt_arith *e,char *buf,int bufsize)
{
	int sign, dp;
	register int i;
	register char *s1;
