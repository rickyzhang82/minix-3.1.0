/* $Id: mkcalls.c,v 1.3 2005/09/01 12:13:27 beng Exp $ */
/*
...
PRIVATE
int
checkarg(struct e_arg *arg,int typset)
{
...
PRIVATE
void
EM_dostartmes(struct e_instr *p)
{
...
EXPORT
int
EM_mkcalls(struct e_instr *line)
{
#ifdef CHECKING
