/* $Id: obj.h,v 1.3 2005/09/01 12:13:26 beng Exp $ */
/*
...
#if ! defined(ACK_BYTE_ORDER)
/* Default to little-endian, suitable for x86 architecture */
# define ACK_BYTE_ORDER 0x0123
#endif

#if (ACK_BYTE_ORDER == 0x3210 || ACK_BYTE_ORDER == 0x1032)
