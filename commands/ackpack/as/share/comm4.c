/* $Id: comm4.c,v 1.1 2005/09/01 12:13:16 beng Exp $ */
/*
...
#ifdef _WIN32 /* MSC, MinGW, CygWin, etc... */
#include <fcntl.h>
#include <io.h>
#endif
...
#ifdef _WIN32
	setmode( fileno( tempfile ), _O_BINARY );
#endif
#ifdef LISTING
	listmode = dflag;
	if (listmode & 0440)
...
#ifdef _WIN32
		setmode( fileno( listfile ), _O_TEXT );
#endif
	}
#endif
...
#ifdef _WIN32 /* MSC, MinGW, CygWin */
	/* Always process input as text, output as binary */
	setmode( 0, _O_TEXT );
	setmode( 1, _O_BINARY );
#endif
