#ifndef NORCSID
static char rcsid[] = "$Id: move.c,v 1.1 2005/09/01 12:13:28 beng Exp $";
#endif
...
int
move(token_p tp1,token_p tp2,int ply,int toplevel,unsigned int maxcost)
{
	register move_p mp;
	unsigned t;
...
int
test(token_p tp,int ply,int toplevel,unsigned int maxcost)
{
	register test_p mp;
	unsigned t;
