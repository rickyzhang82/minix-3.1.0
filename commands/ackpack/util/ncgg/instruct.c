 ...
 */
#ifndef NORCSID
static char rcsid[]= "$Id: instruct.c,v 1.3 2005/09/01 12:13:34 beng Exp $";
#endif
...
expr_t subreg_expr(int,int);
expr_t regno_expr(int);
