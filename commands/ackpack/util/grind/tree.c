/* $Id: tree.c,v 1.1 2005/09/01 12:13:33 beng Exp $ */
...
void
print_node(FILE *f, p_tree p, int top_level)
{
  if (!p) return;
  switch(p->t_oper) {
  case OP_LOG:
