/* $Id: symbol.c,v 1.1 2005/09/01 12:13:33 beng Exp $ */
...
p_symbol
NewSymbol(char *s, p_scope scope, int class, struct outname *nam)
{
...
*/
p_symbol
Lookup(struct idf *id, p_scope scope, int class)
{
...
*/
p_symbol
Lookfromscope(struct idf *id, int class, p_scope sc)
{
...
*/
int
consistent(p_tree p, p_scope sc)
{
  p_tree	arg;
  p_symbol	sym;
  p_scope	target_sc;
...
*/
p_symbol
identify(p_tree p, int class_set)
{
