/* $Id: position.c,v 1.1 2005/09/01 12:13:33 beng Exp $ */
...
*/
p_position
get_position_from_addr(t_addr t)
{
...
*/
t_addr
get_addr_from_position(p_position p)
{
...
*/
void
add_position_addr(char *filename, struct outname *n)
{
...
*/
p_position
print_position(t_addr a, int print_function)
{
