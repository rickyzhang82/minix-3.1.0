/* $Id: c.c,v 1.1 2005/09/01 12:13:33 beng Exp $ */
...
static void
printchar(FILE *f, int c, int esc)
{
  c &= 0377;
  switch(c) {
  case '\n':
...
static
void
print_string(FILE *f, char *s, int len)
{
  register char	*str = s;
