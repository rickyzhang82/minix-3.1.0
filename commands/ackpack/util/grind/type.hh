/* $Id: type.hh,v 1.1 2005/09/01 12:13:33 beng Exp $ */
...
/* Avoid circularity in the types */
struct symbol;

void init_types(void);
p_type subrange_type(int,int *,long,long,int*);
p_type array_type(p_type,p_type);
p_type *tp_lookup(int *);
void clean_tp_tab(void);
void end_literal(p_type,long);
long param_size(p_type, int);
void add_param_type(int,struct symbol *);
long compute_size(p_type, char *);
void set_bounds(p_type);
