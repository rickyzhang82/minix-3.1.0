/* $Id: expr.c,v 1.1 2005/09/01 12:13:33 beng Exp $ */
...
*/
static t_addr
get_addr(p_symbol sym, long *psize)
{
...
static int
get_v(t_addr a, char **pbuf, long size)
{
  if (a) {
...
*/
static int
get_value(p_symbol sym, char **pbuf, long *psize)
{
  p_type	tp = sym->sy_type;
  int		retval = 0;
  t_addr	a;
...
long
get_int(char *buf, long size, int class)
{
  register long l;
...
int
convert(char **pbuf, long *psize, p_type *ptp, p_type tp, long size)
{
...
static int
not_op(p_tree p, char **pbuf, long *psize, p_type *ptp)
{
  p_type target_tp = currlang->has_bool_type ? bool_type : int_type;
...
static int
bnot_op(p_tree p, char **pbuf, long *psize, p_type *ptp)
{
  if (eval_expr(p->t_args[0], pbuf, psize, ptp)) {
	switch((*ptp)->ty_class) {
	case T_INTEGER:
...
static int
ptr_addr(p_tree p, t_addr *paddr, long *psize, p_type *ptp)
{
  char	*buf;
...
static int
deref_op(p_tree p, char **pbuf, long *psize, p_type *ptp)
{
  t_addr addr;
...
static int
addr_op(p_tree p, char **pbuf, long *psize, p_type *ptp)
{
  t_addr addr;
...
static int
unmin_op(p_tree p, char **pbuf, long *psize, p_type *ptp)
{
  if (eval_expr(p->t_args[0], pbuf, psize, ptp)) {
  	switch((*ptp)->ty_class) {
  	case T_SUBRANGE:
...
static int
unplus_op(p_tree p, char **pbuf, long *psize, p_type *ptp)
{
  if (eval_expr(p->t_args[0], pbuf, psize, ptp)) {
  	switch((*ptp)->ty_class) {
  	case T_SUBRANGE:
...
static int (*un_op[])(p_tree,char **,long *,p_type *) = {
  0,
  not_op,
  deref_op,
  0,
...
static int
andor_op(p_tree p, char **pbuf, long *psize, p_type *ptp)
{
  long		l1, l2;
  char		*buf = 0;
  long		size;
...
static int
arith_op(p_tree p, char **pbuf, long *psize, p_type *ptp)
{
  long		l1, l2;
  double	d1, d2;
  char		*buf = 0;
...
static int
sft_op(p_tree p, char **pbuf, long *psize, p_type *ptp)
{
  long		l1, l2;
  char		*buf = 0;
  long		size;
...
static int
cmp_op(p_tree p, char **pbuf, long *psize, p_type *ptp)
{
  long		l1, l2;
  double	d1, d2;
  char		*buf = 0;
...
static int
in_op(p_tree p, char **pbuf, long *psize, p_type *ptp)
{
  long		l;
  char		*buf = 0;
  long		size;
...
static int
array_addr(p_tree p, t_addr *paddr, long *psize, p_type *ptp)
{
  long		l;
  char		*buf = 0;
  long		size;
...
static int
array_op(p_tree p, char **pbuf, long *psize, p_type *ptp)
{
  t_addr	a;
...
static int
select_addr(p_tree p, t_addr *paddr, long *psize, p_type *ptp)
{
  register p_type	tp;
...
static int
select_op(p_tree p, char **pbuf, long *psize, p_type *ptp)
{
  t_addr	a;
...
static int
derselect_op(p_tree p, char **pbuf, long *psize, p_type *ptp)
{
  int	retval;
  t_tree	t;
...
static int (*bin_op[])(p_tree,char **,long *,p_type *) = {
  0,
  0,
  0,
  andor_op,
...
int
eval_expr(p_tree p, char **pbuf, long *psize, p_type *ptp)
{
...
int
eval_desig(p_tree p, t_addr *paddr, long *psize, p_type *ptp)
{
  register p_symbol	sym;
  int	retval = 0;
  t_addr a;
