/* $Id: expr.h,v 1.1 2005/09/01 12:13:33 beng Exp $ */
...
*/
int	eval_desig(p_tree,t_addr*,long*,p_type*);
...
*/
int	eval_expr(p_tree,char**,long*,p_type*);
...
/* int convert(char **pbuf, long *psize, p_type *ptp, p_type tp, long size)
   ...
   psize, respectively.
*/
int	convert(char**,long*,p_type*,p_type,long);
