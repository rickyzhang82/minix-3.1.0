/* $Id: avl.cc,v 1.1 2005/09/01 12:13:33 beng Exp $ */
...
struct avl_tree {
  ...
  int		(*cmp)(char*,char*);	/* address of comparison routine */
};
...
*/
static int
balance_add(struct avl_node **ppsc, char *n, int (*cmp)(char*,char*))
#if 0
...
*/
struct avl_tree *
create_avl_tree(int (*cmp)(char*,char*))
{
...
*/
void
add_to_avl_tree(struct avl_tree *tree, char *n)
#if 0
...
*/
char *
find_ngt(struct avl_tree *tree, char *n)
#if 0
...
*/
char *
find_nlt(struct avl_tree *tree, char *n)
#if 0
  struct avl_tree	*tree;	/* tree to be searched in */
  char			*n;	/* information to be compared with */
#endif
...
*/
char *
find_eq(struct avl_tree *tree, char * n)
#if 0
  struct avl_tree	*tree;	/* tree to be searched in */
  char			*n;	/* information to be compared with */
#endif
