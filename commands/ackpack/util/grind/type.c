/* $Id: type.c,v 1.1 2005/09/01 12:13:33 beng Exp $ */
...
p_type
subrange_type(int A, int *base_index, long c1, long c2, int *result_index)
{
  int itself = 0;
  register p_type p;
  p_type base_type;
...
p_type
array_type(p_type bound_type, p_type el_type)
{
...
void
end_literal(p_type tp, long maxval)
{
...
void
add_param_type(int v, p_symbol s)
#if 0
...
long
compute_size(p_type tp, char *AB)
{
  long	low, high;
