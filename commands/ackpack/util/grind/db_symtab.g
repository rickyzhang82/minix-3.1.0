/* $Id: db_symtab.g,v 1.1 2005/09/01 12:13:33 beng Exp $ */
...
static struct literal *get_literal_space(p_type);
static struct fields *get_field_space(p_type,char *);
static void end_field(p_type);
static char *string_val(char *);
}
...
get_field_space(p_type tp,char *s)
{
