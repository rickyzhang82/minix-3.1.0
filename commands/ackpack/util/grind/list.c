/* $Id: list.c,v 1.1 2005/09/01 12:13:33 beng Exp $ */
...
static void
mk_filnm(char *dir, char *file, char **newname)
{
...
static FILE *
open_file(const char *fn, const char *mode, char **ffn)
{
  FILE	*f;
  char	**p;
...
static
void
line_positions(p_file file, FILE *f)
{
  int		nl;
...
void
lines(p_file file, int l1, int l2)
{
