/* $Id: scope.cc,v 1.1 2005/09/01 12:13:33 beng Exp $ */
...
/*ARGSUSED*/
void
open_scope(p_symbol name, int has_activation)
{
...
*/
p_scope
get_next_scope_from_addr(t_addr a)
{
  t_scope sc;
...
*/
int
scope_encloses(p_scope scope, p_scope from_scope)
{
