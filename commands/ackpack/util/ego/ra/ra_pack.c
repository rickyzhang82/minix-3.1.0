/* $Id: ra_pack.c,v 1.3 2005/09/01 12:13:31 beng Exp $ */
/*
...
STATIC
bool
fits_in(alloc_p a,alloc_p b,bool *cont_item)
{
...
STATIC
alloc_p
find_fitting_alloc(alloc_p alloc,alloc_p packed)
{
...
STATIC
bool
room_for(alloc_p alloc,alloc_p packed)
{
...
STATIC
alloc_p
best_alloc(alloc_p unpacked,alloc_p packed,bool time_opt/*unused*/)
{
...
STATIC
alloc_p
choose_location(alloc_p alloc,alloc_p packed,proc_p p)
{
...
STATIC
void
update_lists(alloc_p alloc,alloc_p unpacked,alloc_p packed,alloc_p fit)
{
...
STATIC
void
best_cumprofits(alloc_p list,alloc_p *x_out,alloc_p *prev_out)
{
...
STATIC
void
account_regsave(alloc_p packed,alloc_p unpacked)
{
...
STATIC
bool
in_single_reg(item_p item,alloc_p packed)
{
...
STATIC
alloc_p
find_prev(alloc_p alloc,alloc_p list)
{
	register alloc_p x;
...
STATIC
void
repl_allocs(alloc_p new,alloc_p old,alloc_p packed)
{
...
STATIC
void
assemble_allocs(alloc_p packed)
{
...
void
pack(alloc_p alloclist,bool time_opt,alloc_p *packed_out,alloc_p *not_packed_out,proc_p p)
{
