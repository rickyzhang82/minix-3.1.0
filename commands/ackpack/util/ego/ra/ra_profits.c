/* $Id: ra_profits.c,v 1.3 2005/09/01 12:13:31 beng Exp $ */
/*
...
STATIC
short
index_value(struct cond_tab tab[],short n,bool time)
{
	cond_p p;
...
void
allocscore(short itemtyp,short localtyp,short size,offset off,short totyp,
...
void
regsave_cost(short regs[],short *time_out,short *space_out)
{
...
void
compute_profits(alloc_p alloclist,bool time_opt)
{
