/* $Id: ra_xform.c,v 1.3 2005/09/01 12:13:31 beng Exp $ */
/*
...
void
init_replacements(short psize,short wsize)
{
...
STATIC
bool
is_current(alloc_p alloc,short t)
{
...
STATIC
bool
match_item(item_p item,line_p l)
{
...
STATIC
alloc_p
find_alloc(alloc_p alloclist,line_p l,short t)
{
...
STATIC
void
replace_line(line_p l,bblock_p b,line_p list)
{
	if (b->b_start == l) {
		b->b_start = list;
	} else {
...
STATIC
line_p
repl_code(line_p lnp,offset regnr)
{
...
STATIC
void
apply_alloc(bblock_p b,line_p l,alloc_p alloc)
{
...
STATIC
line_p
store_local(short size,offset off)
{
...
STATIC
void
append_code(line_p l1,line_p l2,bblock_p b)
{
...
STATIC
void
emit_mesregs(proc_p p,alloc_p alloclist)
{
	line_p l,m,x;
	alloc_p alloc;
...
bool
always_in_reg(offset off,alloc_p allocs,short *size_out)
{
...
void
rem_locals(proc_p p,alloc_p allocs)
{
...
void
rem_formals(proc_p p,alloc_p allocs)
{
