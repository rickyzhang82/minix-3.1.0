/* $Id: ra_interv.c,v 1.3 2005/09/01 12:13:31 beng Exp $ */
/*
...
interv_p
cons_interval(short t_start,short t_stop)
{
	interv_p x;
...
void
add_interval(short t1,short t2,interv_p *list)
{
...
STATIC
void
set_min_max(interv_p *iv1,interv_p *iv2)
{
...
interv_p
intersect(interv_p list1,interv_p list2)
{
...
bool
not_disjoint(interv_p list1,interv_p list2)
{
...
bool
contains(short t,interv_p timespan)
{
