/* $Id: go.c,v 1.3 2005/09/01 12:13:32 beng Exp $ */
/*
...
STATIC
void
mach_init(char *machfile,void (*phase_machinit)(FILE *))
{
...
go(int argc,char *argv[],
	...
	void (*optimize)(proc_p),
	void (*phase_machinit)(FILE *),
	void (*proc_flag)(char *))
{
