/* $Id: parser.c,v 1.3 2005/09/01 12:13:32 beng Exp $ */
/*
...
STATIC
bool
classes(int instr,int *src_out,int *res_out)
{
...
STATIC
bool
parse_locs(line_p l,offset *c1_out,offset *c2_out)
{
...
STATIC
bool
check_args(line_p l,int src_class,int res_class,offset *arg1_out,offset *arg2_out)
{
...
STATIC
offset
nrbytes(int class,offset arg1,offset arg2)
{
...
STATIC
void
attrib(line_p l,offset *expect_out,offset *srcb_out,offset *resb_out)
{
...
bool
parse(line_p l,offset nbytes,line_p *l_out,int level,void (*action0)(line_p,line_p,offset))
{
