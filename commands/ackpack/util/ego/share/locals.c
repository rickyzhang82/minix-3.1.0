/* $Id: locals.c,v 1.3 2005/09/01 12:13:32 beng Exp $ */
/*
...
STATIC
void
localvar(offset off,short size,local_p *locs,bool reg,offset score)
{
...
STATIC
void
check_message(line_p l,local_p *locs)
{
...
STATIC
void
check_local_use(line_p l,local_p *locs)
{
	short sz;
...
void
find_local(offset off,short *nr_out,bool *found_out)
{
...
void
var_nr(line_p l,short *nr_out,bool *found_out)
{
