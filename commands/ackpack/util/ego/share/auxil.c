/* $Id: auxil.c,v 1.3 2005/09/01 12:13:32 beng Exp $ */
/*
...
line_p
reg_mes(offset tmp,short size,int typ,int score)
{
...
bblock_p
common_dom(bblock_p a,bblock_p b)
{
...
short
add_timespace(short time,short space)
{
...
void
appnd_line(line_p l1,line_p l2)
{
	/* Put l1 after l2 */
