/* $Id: lv.c,v 1.3 2005/09/01 12:13:31 beng Exp $ */
/*
...
STATIC
void
unite_ins(lset bbset,cset *setp)
{
...
STATIC
void
live_variables_analysis(proc_p p)
{
	make_localtab(p);
...
STATIC
line_p
make_mesg(short mesg,local_p loc)
{
...
STATIC
void
block_entry(bblock_p b,bblock_p prev)
{
	short v,vn;
	local_p loc;
...
STATIC
void
definition(line_p l,bool *useless_out,short *v_out,bool mesgflag)
{
...
STATIC
void
nothing(line_p x,line_p y,offset z)
{ }  /* No action to be undertaken at level 0 of parser */

STATIC
void
rem_code(line_p l1,line_p l2,bblock_p b)
{
	line_p l,x,y,next;
...
void
lv_mesg(proc_p p,bool mesgflag)
{
...
{
	go(argc,argv,init_globals,lv_optimize,(void (*)(FILE *))no_action,lv_flags);
