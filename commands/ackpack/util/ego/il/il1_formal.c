/* $Id: il1_formal.c,v 1.3 2005/09/01 12:13:31 beng Exp $ */
/*
...
formal_p
find_formal(proc_p p,int type,offset off)
{
...
void
formal(proc_p p,bblock_p b,offset off,int type,int usage)
{
