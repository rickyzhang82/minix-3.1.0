/* $Id: il3_change.c,v 1.3 2005/09/01 12:13:31 beng Exp $ */
/*
...
STATIC
void
store_tmp(proc_p p,line_p l,offset size)
{
...
STATIC
void
chg_actuals(call_p c,line_p cal)
{
...
STATIC
void
rm_callpart(call_p c,line_p cal)
{
...
void
chg_callseq(call_p c,line_p cal,line_p *l_out)
{
...
STATIC
void
act_info(offset off,actual_p acts,offset ab_off,actual_p *act_out,offset *off_out)
{
...
STATIC
void
inl_actual(line_p l,line_p expr)
{
...
STATIC
void
localref(line_p l,call_p c,offset ab_off,offset lb_off)
{
...
STATIC
void
chg_mes(line_p l,call_p c,offset ab_off,offset lb_off)
{
...
STATIC
void
chg_ret(line_p l,call_p c,line_p lab)
{
...
STATIC
void
mod_instr(line_p l,call_p c,line_p lab,offset ab_off,offset lb_off,int lab_off)
{
...
void
modify(line_p text,call_p c,line_p lab,offset ab_off,offset lb_off,int lab_off)
{
...
void
mod_actuals(call_p nc,call_p c,line_p lab,offset ab_off,offset lb_off,int lab_off)
{
	actual_p act;
	line_p l, next, dum;
...
void
insert(line_p text,line_p l,line_p firstline)
{
...
void
liquidate(proc_p p,line_p text)
{
