/* $Id: il2_aux.c,v 1.3 2005/09/01 12:13:31 beng Exp $ */
/*
...
STATIC
bool
match_pars(formal_p fm,actual_p act)
{
...
STATIC
bool
change_act(proc_p p,actual_p act)
{
...
STATIC
bool
too_expensive(formal_p fm,actual_p act)
{
...
STATIC
void
adjust_counts(proc_p callee,FILE *ccf)
{
...
STATIC
bool
is_dispensable(proc_p callee,FILE *ccf)
{
	/* A call to callee is expanded in line.
...
STATIC
void
compare(call_p x,call_p *best,long space)
{
...
STATIC
call_p
best_one(call_p list,long space)
{
...
void
select_calls(proc_p proclist,FILE *ccf,long space)
{
...
STATIC
void
copy_pars(call_p src,call_p dest)
{
...
void
add_actuals(proc_p proclist,FILE *cfile)
{
...
void
append_abstract(call_p a,proc_p p)
{
...
void
Sstatist(call_p list,long space)
{
	call_p c;
...
void
Sstat(proc_p proclist,long space)
{
	proc_p p;
