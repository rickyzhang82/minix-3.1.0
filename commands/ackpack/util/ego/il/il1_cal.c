/* $Id: il1_cal.c,v 1.3 2005/09/01 12:13:31 beng Exp $ */
/*
...
STATIC
void
make_actual(line_p l1,line_p l2,offset size)
{
...
STATIC
void
inc_count(proc_p caller,proc_p callee)
{
...
void
anal_cal(proc_p p,line_p call,bblock_p b,FILE *cf)
{
