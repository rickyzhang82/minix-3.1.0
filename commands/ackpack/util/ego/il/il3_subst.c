/* $Id: il3_subst.c,v 1.3 2005/09/01 12:13:31 beng Exp $ */
/*
...
line_p
scan_to_cal(line_p lines,short n)
{
...
void
substitute(FILE *lf,call_p c,line_p cal,line_p firstline)
{
