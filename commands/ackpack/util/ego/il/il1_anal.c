/* $Id: il1_anal.c,v 1.3 2005/09/01 12:13:31 beng Exp $ */
/*
...
STATIC
void
check_labels(proc_p p,arg_p arglist)
{
...
STATIC
void
anal_instr(proc_p p,bblock_p b,FILE *cf)
{
...
void
anal_proc(proc_p p,FILE *cf,FILE *ccf)
{
