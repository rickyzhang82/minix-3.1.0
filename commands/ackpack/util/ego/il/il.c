/* $Id: il.c,v 1.3 2005/09/01 12:13:31 beng Exp $ */
/*
...
void
pass1(char *lnam,char *bnam,char *cnam)
{
...
main(int argc,char *argv[])
{
	...
	go(argc,argv,(void (*)(void))no_action,(void (*)(proc_p))no_action,(void (*)(FILE *))no_action,il_flags);
