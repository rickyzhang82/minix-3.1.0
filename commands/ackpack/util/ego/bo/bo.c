/* $Id: bo.c,v 1.3 2005/09/01 12:13:29 beng Exp $ */
/*
...
STATIC
line_p
last_code(line_p lines,bool skip_pseu)
{
...
STATIC
void
bo_optloop(proc_p p,bblock_p b,bblock_p x,line_p bra,line_p bcc)
{
	bblock_p prevb,n;
	line_p l;
...
STATIC
void
mv_code(bblock_p b1,bblock_p b2)
{
	line_p l,x;
...
{
	go(argc,argv,(void (*)(void))no_action,bo_optimize,(void (*)(FILE *))no_action,(void (*)(char *))no_action);
