/* $Id: sp.c,v 1.3 2005/09/01 12:13:32 beng Exp $ */
/*
...
void
comb_asps(line_p l1,line_p l2,bblock_p b)
{
...
{
	go(argc,argv,(void (*)(void))no_action,sp_optimize,sp_machinit,(void (*)(char *))no_action);
