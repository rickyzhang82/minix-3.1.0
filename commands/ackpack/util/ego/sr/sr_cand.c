/* $Id: sr_cand.c,v 1.3 2005/09/01 12:13:32 beng Exp $ */
/*
...
STATIC
void
try_cand(line_p lnp,bblock_p b)
{
...
void
candidates(loop_p lp,lset *cand_out,lset *vars_out)
{
