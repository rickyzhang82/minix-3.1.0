/* $Id: sr_xform.c,v 1.3 2005/09/01 12:13:32 beng Exp $ */
/*
...
line_p
move_pointer(offset tmp,int dir)
{
...
STATIC
void
copy_loops(bblock_p b1,bblock_p b2,loop_p except)
{
...
STATIC
void
adjust_jump(bblock_p newtarg,bblock_p oldtarg,bblock_p c)
{
