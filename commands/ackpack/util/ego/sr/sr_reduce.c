/* $Id: sr_reduce.c,v 1.3 2005/09/01 12:13:32 beng Exp $ */
/*
...
STATIC
void
gen_regmes(offset tmp,int score,code_p code,proc_p p)
{
...
STATIC
line_p
newcode(code_p code,offset tmp)
{
...
STATIC
void
replcode(code_p code,line_p text)
{
...
STATIC
void
init_code(code_p code,offset tmp)
{
...
STATIC
void
incr_code(code_p code,offset tmp)
{
...
STATIC
bool
same_address(line_p l1,line_p l2,lset vars)
{
...
STATIC
bool
same_expr(line_p lb1,line_p le1,line_p lb2,line_p le2)
{
...
STATIC
bool
same_code(code_p c1,code_p c2,lset vars)
{
...
STATIC
void
try_multiply(loop_p lp,lset ivs,lset vars,bblock_p b,line_p mul)
{
...
STATIC
void
try_leftshift(loop_p lp,lset ivs,lset vars,bblock_p b,line_p shft)
{
...
STATIC
void
try_array(loop_p lp,lset ivs,lset vars,bblock_p b,line_p arr)
{
...
void
strength_reduction(loop_p lp,lset ivs,lset vars)
#if 0
