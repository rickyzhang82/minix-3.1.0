/* $Id: sr_aux.c,v 1.3 2005/09/01 12:13:32 beng Exp $ */
/*
...
bool
is_loopconst(line_p lnp,lset vars)
{
	Lindex i;
...
bool
is_caddress(line_p lnp,lset vars)
...
void
concatenate(line_p list1,line_p list2)
{
