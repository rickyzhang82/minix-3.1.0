/* $Id: sr_expr.c,v 1.3 2005/09/01 12:13:32 beng Exp $ */
/*
...
STATIC
int
me_kind(line_p l,int sign_in,int *sign_out)
{
	if (l != (line_p) 0) {
		switch(INSTR(l)) {
			case op_adi:
...
STATIC
bool
match_expr(line_p l,bool iv_allowed,line_p *lbegin,bool *iv_seen,int sign)
{
...
bool
is_ivexpr(line_p l,lset ivs,lset vars,line_p *lbegin_out,iv_p *iv_out,int *sign_out)
{
	line_p l2;
	bool iv_seen;
