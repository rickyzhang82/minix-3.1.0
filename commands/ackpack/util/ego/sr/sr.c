/* $Id: sr.c,v 1.3 2005/09/01 12:13:32 beng Exp $ */
/*
...
{
	go(argc,argv,(void (*)(void))no_action,sr_optimize,sr_machinit,(void (*)(char *))no_action);
