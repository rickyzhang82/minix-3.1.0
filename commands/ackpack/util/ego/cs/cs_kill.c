/* $Id: cs_kill.c,v 1.3 2005/09/01 12:13:30 beng Exp $ */
/*
...
STATIC
bool
obj_overlap(obj_p op1,obj_p op2)
{
...
STATIC
void
kill_external(obj_p obp,int indir)
{
...
STATIC
bool
loc_overlap(entity_p enp1,entity_p enp2)
{
...
STATIC
void
kill_local(entity_p enp,bool indir)
{
