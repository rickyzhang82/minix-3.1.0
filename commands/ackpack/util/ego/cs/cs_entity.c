/* $Id: cs_entity.c,v 1.3 2005/09/01 12:13:30 beng Exp $ */
/*
...
STATIC
bool
same_entity(entity_p enp1,entity_p enp2)
{
...
STATIC
void
copy_entity(entity_p src,entity_p dst)
{
