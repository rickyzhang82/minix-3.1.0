/* $Id: cs_profit.c,v 1.3 2005/09/01 12:13:30 beng Exp $ */
/*
...
STATIC
void
choose_cset(FILE * f,cset * s_p,int max)
{
...
STATIC
bool
okay_lines(avail_p avp,occur_p ocp)
{
