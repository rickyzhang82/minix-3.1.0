/* $Id: cs_elim.c,v 1.3 2005/09/01 12:13:30 beng Exp $ */
/*
...
STATIC
void
remove_lines(line_p first,line_p last)
{
...
STATIC
bool
contained(occur_p ocp1,occur_p ocp2)
{
...
STATIC
void
delete(occur_p ocp,avail_p start)
{
...
STATIC
void
complete_aar(line_p lnp,int instr,valnum descr_vn)
{
...
STATIC
void
replace(occur_p ocp,offset tmp,avail_p avp)
{
...
STATIC
void
set_replace(avail_p avp,offset tmp)
{
...
STATIC
line_p
gen_mesreg(offset off,avail_p avp,proc_p pp)
{
...
STATIC
void
change_score(line_p mes,int score)
{
