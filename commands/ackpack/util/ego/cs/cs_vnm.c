/* $Id: cs_vnm.c,v 1.3 2005/09/01 12:13:30 beng Exp $ */
/*
...
STATIC
void
push_entity(entity_p enp,line_p lfirst)
{
...
STATIC
void
put_expensive_load(bblock_p bp,line_p lnp,line_p lfirst,entity_p enp)
{
	struct avail av;
	occur_p	ocp;
...
STATIC
void
put_aar(bblock_p bp,line_p lnp,line_p lfirst,entity_p enp)
{
...
STATIC
void
push_avail(avail_p avp,line_p lfirst)
{
	struct token tk;
...
STATIC
void
push_unair_op(bblock_p bp,line_p lnp,token_p tkp1)
{
	struct avail av;
	occur_p	ocp;
...
STATIC
void
push_binair_op(bblock_p bp,line_p lnp,token_p tkp1,token_p tkp2)
{
	struct avail av;
	occur_p	ocp;
...
STATIC
void
push_ternair_op(bblock_p bp,line_p lnp,token_p tkp1,token_p tkp2,token_p tkp3)
{
	struct avail av;
	occur_p	ocp;
