/* $Id: cs_avail.c,v 1.3 2005/09/01 12:13:30 beng Exp $ */
/*
...
STATIC
bool
same_avail(byte kind,avail_p avp1,avail_p avp2)
{
...
STATIC
entity_p
result_local(offset size,line_p l)
{
...
STATIC
void
copy_avail(int kind,avail_p src,avail_p dst)
{
...
avail_p
av_enter(avail_p avp,occur_p ocp,int kind)
{
