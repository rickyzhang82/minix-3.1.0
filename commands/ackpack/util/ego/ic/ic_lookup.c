/* $Id: ic_lookup.c,v 1.3 2005/09/01 12:13:31 beng Exp $ */
/*
...
dblock_p
symlookup(char * name,int status)
{
...
proc_p
proclookup(char * name,int status)
{
...
void
dump_procnames(prc_p hash[],int n,FILE *f)
{
...
void
cleanprocs(prc_p hash[],int n,int mask)
{
...
void
dump_dblocknames(sym_p hash[],int n,FILE * f)
{
...
void
cleandblocks(sym_p hash[],int n,int mask)
{
	/* After an EM input file has been processed, the names
