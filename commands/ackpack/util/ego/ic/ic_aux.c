/* $Id: ic_aux.c,v 1.3 2005/09/01 12:13:31 beng Exp $ */
/*
...
STATIC
offset
blocksize(byte pseudo,arg_p args)
{
...
void
dblockdef(dblock_p db,int n,line_p lnp)
{
...
void
combine(dblock_p db,line_p l1,line_p l2,byte pseu)
{
...
STATIC
void
arg_string(offset length,argb_p abp)
{
...
STATIC
obj_p
make_object(dblock_p dbl,offset off,offset size)
{
...
obj_p
object(char * ident,offset off,offset size)
{
	dblock_p dbl;
