/* $Id: ud_defs.c,v 1.3 2005/09/01 12:13:33 beng Exp $ */
/*
...
STATIC
bool
same_target(line_p l,short defnr)
{
...
STATIC
void
rem_prev_defs(line_p l,cset *gen_p)
{
...
STATIC
void
impl_globl_defs(proc_p p,cset *gen_p)
{
...
STATIC
void
impl_gen_defs(line_p l,cset *gen_p)
{
...
STATIC
void
killed_defs(short v,bblock_p b)
{
