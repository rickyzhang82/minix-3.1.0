/* $Id: ud_const.c,v 1.3 2005/09/01 12:13:33 beng Exp $ */
/*
...
bool
value_known(line_p def,offset *val_out)
{
...
bool
affected(line_p use,short v,line_p l)
{
...
STATIC
void
search_backwards(line_p use,short v,bool *found,line_p *def)
{
...
line_p
unique_def(line_p use,bblock_p b,short *defnr_out)
{
...
void
fold_const(line_p l,bblock_p b,offset val)
{
