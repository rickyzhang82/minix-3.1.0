/* $Id: ud_copy.c,v 1.3 2005/09/01 12:13:33 beng Exp $ */
/*
...
STATIC
void
traverse_defs(proc_p p,int action)
{
	bblock_p b;
	line_p l;
	bool found;
...
STATIC
bool
is_changed(line_p varl,line_p start,line_p stop)
{
...
STATIC
void
intersect_outs(lset bbset,cset *setp,cset full_set)
{
...
STATIC
void
init_cin(proc_p p,cset full_set)
{
...
void
fold_var(line_p old,line_p new,bblock_p b)
{
...
bool
value_retained(line_p copy,short defnr,line_p use,bblock_p b)
{
