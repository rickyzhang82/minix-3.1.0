/* $Id: ud.c,v 1.3 2005/09/01 12:13:32 beng Exp $ */
/*
...
STATIC
bool
test_cond(short cond,offset val)
{
	switch(cond) {
		case DEFAULT:
			return TRUE;
...
STATIC
short
map_value(struct cond_tab tab[],offset val,bool time)
{
	cond_p p;
...
STATIC
void
unite_outs(lset bbset,cset *setp)
{
...
STATIC
bool
fold_is_desirable(line_p old,line_p new)
{
...
void
pr_set(char *name,short k,cset s,short n)
{
	short i;
...
{
	go(argc,argv,init_globals,ud_optimize,ud_machinit,(void (*)(char *))no_action);
