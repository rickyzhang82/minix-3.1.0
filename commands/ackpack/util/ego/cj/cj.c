/* $Id: cj.c,v 1.3 2005/09/01 12:13:30 beng Exp $ */
/*
...
STATIC
bool
same_instr(line_p l1,line_p l2)
{
...
STATIC
void cp_loops(bblock_p b1,bblock_p b2)
{
...
STATIC
void
jump_cross(line_p l1,line_p l2,bblock_p b1,bblock_p b2)
{
...
STATIC
bool
try_tail(bblock_p b1,bblock_p b2)
{
...
{
	go(argc,argv,(void (*)(void))no_action,cj_optimize,(void (*)(FILE *))no_action,(void (*)(char *))no_action);
