/* $Id: cf_succ.c,v 1.3 2005/09/01 12:13:30 beng Exp $ */
/*
...
STATIC
void
succeeds(bblock_p succ,bblock_p pred)
{
...
STATIC
arg_p
use_label(arg_p arg,bblock_p b)
{
...
STATIC
void
case_flow(short instr,line_p desc,bblock_p b)
{
...
STATIC
void
last2_instrs(bblock_p b,line_p * last_out,line_p * prev_out)
{
