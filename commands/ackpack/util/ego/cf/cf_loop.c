/* $Id: cf_loop.c,v 1.3 2005/09/01 12:13:30 beng Exp $ */
/*
...
STATIC
bool
inner_loop(loop_p l1,loop_p l2)
{
...
STATIC
void
insrt(bblock_p b,lset * lpb,lset * s_p)
{
...
STATIC
loop_p
natural_loop(bblock_p d,bblock_p n)
{
...
STATIC
bool
does_exit(bblock_p b,loop_p lp)
{
...
STATIC
void
mark_succ(bblock_p b,loop_p lp)
{
	Lindex i;
	bblock_p succ;
