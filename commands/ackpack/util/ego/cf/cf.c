/* $Id: cf.c,v 1.3 2005/09/01 12:13:30 beng Exp $ */
/*
...
STATIC
bool
getbblocks(FILE * fp,short * kind_out,short * n_out,bblock_p * g_out,line_p * l_out)
{
