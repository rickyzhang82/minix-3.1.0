...
# ifndef NORCSID
static const_string rcsid4 = "$Id: global.c,v 1.3 2005/09/01 12:13:29 beng Exp $";
# endif
...
#endif
char	f_out[20];
const_string	f_input;
char	f_include[20];
char	f_rec[20];
const_string	e_noopen = "Cannot open %s";
int	verbose;
int	wflag;
const_string	lexical;
string	prefix;
string	onerror;
int	ntneeded;
int	ntprint;
...
p_file	maxfiles;
p_file	pfile;
const_string	LLgenid = "/* LLgen generated code from source %s */\n";
t_token lextoken;
int	nerrors;
