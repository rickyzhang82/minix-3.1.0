...
# ifndef NORCSID
static const_string rcsid7 = "$Id: name.c,v 1.3 2005/09/01 12:13:29 beng Exp $";
# endif
...
static const_string	e_literal = "Illegal literal";
static p_entry	entries, maxentries;
static t_info	token_info, nont_info;

/* Defined in this file are: */
STATIC int	hash(const_string);
STATIC p_entry	newentry(string,p_entry);
...
p_gram
search(type,str,option)
	int type;
	register const_string str;
	int option;
{
	/*
