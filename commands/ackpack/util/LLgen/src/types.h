...
/*
 * Function prototype support: to ANSI or not?
 */
#ifndef _P
...
/*
 * $Id: types.h,v 1.3 2005/09/01 12:13:29 beng Exp $
...
typedef struct token {
	...
	union {
		const_string	t_s;	/* Attribute is either a string or */
		int	t_v;	/* an integer */
	} t_x;
...
# define setntout(p,i)	{assert(((unsigned)(i))<=NOSAFETY);(p)->n_outsafety=(i);}
	...
	union {
		...
		const_string	n_s;	/* If this nonterminal is not declared,
