...
# ifndef NORCSID
static const_string rcsid1 = "$Id: check.c,v 1.3 2005/09/01 12:13:29 beng Exp $";
# endif

static const_string	c_first = "> firstset   ";
static const_string	c_contains = "> containset ";
static const_string	c_follow = "> followset  ";
static int	level;

/* In this file are defined : */
STATIC void	prline(const char*);
STATIC void	printset(p_set,const_string);
