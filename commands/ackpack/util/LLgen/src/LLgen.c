...
#define LL_ANSI_C 1
#define LL_LEXI scanner
/* $Id: LLgen.c,v 1.3 2005/09/01 12:13:28 beng Exp $ */
#ifdef LL_DEBUG
#include <assert.h>
#include <stdio.h>
...
# ifndef NORCSID
static const_string	rcsid = "$Id: LLgen.c,v 1.3 2005/09/01 12:13:28 beng Exp $";
# endif
...
STATIC void	mkalt(p_gram,int,int,p_gram);
STATIC void	mkterm(p_gram,int,int,p_gram);
STATIC p_gram	copyrule(p_gram,int);
