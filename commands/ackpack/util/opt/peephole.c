#ifndef NORCSID
static char rcsid[] = "$Id: peephole.c,v 1.3 2005/09/01 12:13:35 beng Exp $";
#endif
...
bool
tryrepl(line_p *lpp,byte *bp,int patlen)
{
...
bool
trypat(line_p * lpp,byte *bp,int len)
{
	register iarg_p iap;
	int i,patlen;
	register line_p lp;
...
int
repl_mul(line_p lp,line_p * b,line_p * e)
{
