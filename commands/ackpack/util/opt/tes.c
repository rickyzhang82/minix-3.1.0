#ifndef NORCSID
static char rcsid[] = "$Id: tes.c,v 1.3 2005/09/01 12:13:35 beng Exp $";
#endif
/*
...
void
tes_instr(line_p lnp,line_p x,line_p y)
{
	char *s;
...
void
do_inst_label(line_p lnp)	/* (re-)install a label */
{
