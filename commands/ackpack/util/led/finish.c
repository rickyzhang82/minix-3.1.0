 ...
 */
#ifndef lint
static char rcsid[] = "$Id: finish.c,v 1.3 2005/09/01 12:13:33 beng Exp $";
#endif
...
static
void
handle_relos(struct outhead *head,struct outsect *sects,struct outname *names)
{
...
static
void
put_locals(struct outname *name,unsigned int nnames)
{
...
static
void
compute_origins(struct outsect *sect,unsigned int nsect)
{
...
void
do_crs(struct outname *base,unsigned int count)
{
...
static
void
adjust_names(struct outname *name,struct outhead *head,char *chars)
{
	register int		cnt;
