 ...
 */
#ifndef lint
static char rcsid[] = "$Id: sym.c,v 1.3 2005/09/01 12:13:34 beng Exp $";
#endif
 ...
 */ 
struct outname *
searchname(char *string,int hashval)
{
	register char		*rcp;
 ...
 */
void
entername(struct outname *name,int hashval)
{
	ind_t		savindex;
	ind_t		symindex;
	ind_t		namindex;
