 ...
 */
#ifndef lint
static char rcsid[] = "$Id: main.c,v 1.3 2005/09/01 12:13:33 beng Exp $";
#endif
...
static void		setlign(int sectno,long lign);
...
static
void
initializations(int argc,char * argv[])
{
	/*
	 * Avoid malloc()s.
	 */
