 ...
 */
#ifndef lint
static char rcsid[] = "$Id: relocate.c,v 1.3 2005/09/01 12:13:34 beng Exp $";
#endif
...
static
void
putvalu(long valu,char addr[],char type)
{
	unsigned short	word0, word1;
...
static
unsigned
addrelo(struct outrelo *relo,struct outname *names,long *valu_out)
{
 ...
 */
void
relocate(struct outhead *head,char *emit,struct outname names[],struct outrelo *relo,long off)
{
	long		valu;
