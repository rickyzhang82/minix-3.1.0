...
# ifdef _MINIX /* Minix, use defines from <utmp.h> */
/* Under Minix we use wtmp to get #users logged in and (re)boot time, because 
 * utmp provides unly #users logged in (albeit easier to deduce).
 */
# undef UTMP_FILE
# define UTMP_FILE WTMP
# undef WTMP_FILE
# define WTMP_FILE UTMP
# endif /* _MINIX */
