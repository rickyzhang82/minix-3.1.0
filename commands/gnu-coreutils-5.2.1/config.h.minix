...
#define HAVE_GETHOSTID 1 /* Minix impl in lib/gethostid.c */
...
#define HAVE_SETHOSTNAME 1 /* Minix impl in lib/sethostname.c */
...
#define HOST_OPERATING_SYSTEM "Minix" /* hinting this in config.hin fails */
